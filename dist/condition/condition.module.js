...
const condition_resolver_1 = require("./condition.resolver");
let ConditionModule = class ConditionModule {
};
ConditionModule = __decorate([
    (0, common_1.Module)({
        providers: [condition_resolver_1.ConditionResolver, condition_service_1.ConditionService]
    })
], ConditionModule);
